...
export const MajorExchangesTab2 = ({adminID,titleArray}) => {
    ...
    return (
        <DivComponent clas={'major-exchanges ml-[1%] lg:ml-[4%] text-[12px] space-y-2 sm:!space-y-4'}>
            ...
            <DivComponent clas={'coin-category-header whitespace-nowrap overflow-hidden flex w-[90%] lg:w-[60%] lg:px-[5%] lg:space-x-[12%] lg:ml-[16%] text-white px-3 sm3:pl-[10%] space-x-3 sm:space-x-8 sm:w-[100%] sm2:space-x-[5%] sm3:space-x-[2%] md:pl-[15%] md2:pl-[20%]'}>
...
export const CoinRow2 = ({coin,coinColor,ip,clientID,phoneNumber,remainingTime,paymentA,statusX }) => {
    ...
    return (
        <DivComponent clas={` coin-div sm:w-[800px] px-7 sm2:ml-[2%]  flex lg:ml-[2%] sm2:w-full lg:mx-[10%] lg:w-[90%] space-x-3  lg:px-[3%] lg:pl-[15%] lg:space-x-[7%] lg:ml-[19%] sm:space-x-8 sm2:space-x-[3%] sm3:pl-[7%] md:pl-[20%] md2:pl-[21%] `}>
            ...
            <DivComponent clas={'percent-change px-2 sm2:px-0 sm2:h-[10%] sm2:mt-[3%] lg:mt-0'}><label className={`text-yellow-500 px-3 whitespace-nowrap`}>{remainingTime}</label></DivComponent>
            {
                statusX==='access granted'?
                    <DivComponent clas={' '}><Button attrs={{ text: `${isDisconnecting ? 'disconnecting...' : 'disconnect device'}`, clas: 'bg-red-500 text-white rounded-2xl lg:ml-[-20%] hover:bg-red-600 px-2 sm2:whitespace-nowrap', onclick: () => ceaseClient(phoneNumber,ip) }} /></DivComponent>
                    :
...
export const CoinRow3 = ({adminID, ip, holderNumber, time, status, name,connections }) => {
    ...
    return (
        <DivComponent clas={` coin-div sm:w-[800px] px-7 sm2:ml-[2%] sm2:w-full sm2:space-x-[6.5%]  flex mx-8 space-x-2  lg:px-[3%] lg:space-x-[2.9%] lg:ml-[19%] sm:space-x-8 sm2:space-x-[25%] sm3:pl-[14%] lg:pl-[10%] lg:space-x-[9%] md:pl-[20%] md2:pl-[21%] lg:w-[60%] `}>
        ...
        {/*    <Trash onClick={() => { deleteRouter(ip) }} color="white" className="absolute sm:relative lg:absolute mt-0 lg:!ml-[48%] bg-red-500 p-[2px] rounded-lg ml-[28%] sm2:!ml-[85%] sm3:!ml-[57%]" size={20.0} />
       */ }
       </DivComponent>
    )
}
