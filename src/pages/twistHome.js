   ...
   // alert(routers);
    ...
    const generateNewToken = (Event) => {
        ...
        const value = Event.target.value.split('-')[0];
         expiry = value * 3600; //coverting hours to seconds
    }
            ...
            <DivComponent clas={'top-level-div bg-startColor'}>
                <DivComponent clas={'main-inner-div text-[14px] sm2:text-[15px] '}>
                    <NavBar clas={'p-3 fixed mt-[-18%] sm:mt-[-16%] sm2:mt-[-11%] sm3:mt-[-9%] md:mt-[-7%] md2:mt-[-5%] '}>
                        <DivComponent clas={'flex font-bold space-x-[40%] mt-[3%]  sm2:mt-[8%] md:text-[50px] lg:text-[20px] lg:ml-[2%] md:mt-[3%] sm2:text-[30px]  sm2:ml-[25%] md2:mt-[2%] text-white '}>
                    ...
                    <DivComponent clas={'main-window2 sm2:w-[500px] sm2:mx-[5%] sm2:pt-[20%] lg:pt-2 md:w-full  pb-2 mt-10 pt-4 space-y-8  bg-gradient-to-b from-startColor via-mainColor to-darkColor'}>
                        ...
                        <h2 className='text-lg text-white font-semibold  text-white-800 mb-4'>Package choice for Today(Note:This data resets everyday)</h2>                        

                        <DivComponent clas={'!mb-[10%] sm2:!mb-[30%] lg:!mb-[10%]'}>
                        <DivComponent clas={'graph-area !space-y-2 lg:flex lg:space-x-2 w-full text-white  relative font-semibold '}>
                            {
                                ...
                                storeState === true ?? routers.length > 0 ? routers.map(router => {
                                    ...
                                    return (
                                        ...
                                        <div id={`charts-${counter.current}`} className={` lg:space-x-8 w-[80%] ${counter.current == 1 ? 'md:flex' : 'hidden'} space-y-3 sm2:space-y-[5%]`}>
                                            ...
                                            <DivComponent clas={'bg-darkColor shadow-lg hover:scale-105 h-[55vh] sm2:h-[40vh]  rounded-2xl p-6  w-full agent-profit-loss-graph sm2:!ml-[5%] sm3:!ml-[10%] ml-[2%] !pt-3 !w-[90%] lg:mt-[5%] lg:!w-[40%]  '}>
                                                <BarX tokens={data} />
                                            </DivComponent>

                                            <DivComponent clas={'absolute lg:!ml-[30%] lg:!mt-[24%] md2:!mt-[50%] sm2:ml-[30%] sm3:mt-[5%] md:!mt-[60%] sm2:w-[30%] rounded-xl bg-blue-500 p-3 text-white'}><label>{ router.name}</label></DivComponent>
                                        </div>
                            ...
                            <DivComponent clas={'navigation-arrow rounded-xl p-3 absolute lg:!ml-[87%] lg:!mt-[-12%] sm2:ml-[80%] sm2:!mt-[4%]'}>
                            ...
                            <DivComponent clas={'text-white text-lg sm2:px-[10%] font-semibold'}><label>Please note that these tokens are deleted in memory once their lifetime expires.</label></DivComponent>
                        ...
                        <DivComponent clas={'coin-list-div bg-darkColor text-[12px] p-3 sm2:px-0 sm2:ml-[-5%] lg:w-[76%] lg:px-0 lg:ml-[12%]  !max-h-[200px] space-y-4 !mt-[7px] mx-3'}>
                            {
                                ...
                                storeState===true ?( runningCodes.length>0 ?runningCodes.map(code => {
                                    ...
                                    return (
                                        <CoinRow2 coin={code.code} clientID={code.clientID} coinColor={color}  statusX={code.status} ip={code.ipAddress} paymentA={code.payment} remainingTime={Math.floor(code.expiry)+' Hrs'} phoneNumber={code.phoneNumber} />
                                    )
                                }) :
                        ...
                        <DivComponent clas={'text-white text-lg font-semibold'}><label>Available packages.</label></DivComponent>                        

                        <DivComponent clas={'lg:flex ml-[25%]  lg:ml-[10%] space-x-3 lg:space-x-[20%]'}>
                            <DivComponent clas={'coin-list-div sm2:ml-[-30%] sm3:ml-[-20%] bg-darkColor lg:px-6 lg:ml-[-4%] lg:w-[40%] py-3 text-[12px] w-[50%] sm2:w-full lg:!max-h-[30%] space-y-2 !mt-[7px] lg:!mt-[-2%]'}>
                            {
                                storeState === true ? (packageList.length>0 ? packageList.map(code => {
                                    return (
                                        <DivComponent clas={''}>
                                            ...
                                            <Trash onClick={() => { deleteItem(code.duration) }} color="white" className="absolute p-[2px] rounded-lg mt-[-1.5%] lg:!mt-[-1%] sm2:ml-[70%] bg-red-500  sm3:ml-[50%] md:!ml-[60%] md:!mt-[-3%] sm2:mt-[-5%] lg:!ml-[22%] ml-[28%]" size={20.0}/>
                                        </DivComponent>
                                    )
                            ...
                            <DivComponent clas={'space-y-2 new-package-div p-4 sm2:mt-[10%] sm2:!ml-[-25%] lg:w-[50%] lg:!ml-[5%] lg:mt-[-2%] sm3:!ml-[-15%] sm2:w-[90%]'}>
                                <InputWithLabel text={'New Package Name:'} id={'new-pack'}/>
                        ...
                        <MajorExchangesTab2 adminID={admin.uniqueID} titleArray={['Name', 'ip', 'holder', 'status', 'connections','last updated']} />
                        ...
                        <DivComponent clas={'space-y-2 new-package-div hover:scale-105 new-router-div mx-[20%] p-4'}>
                           <DivComponent clas={'flex'}>
                            ...
                            <InputWithLabel clas={'w-[30%]'} text={'holder digits(optional):'} id={'holder-digits'} />
                            </DivComponent>
                        ...
                        <DivComponent clas={'timeframe-div flex ml-[20%] sm3:ml-[33%] lg:!ml-[43%] md:ml-[37%] md2:ml-[40%] text-white space-x-2'}>
                        ...
                        <DivComponent clas={'text-white text-[14px]  font-semibold main-label text-lg lg:!mt-[1%]'}><label>Your Token code is:</label></DivComponent>
                            ...
                            {showCopyIcon ? <Copy size={20.5} onClick={async () => {
                                await navigator.clipboard.writeText(document.getElementById('token-code').value);
                                setCopy(false);
                            }}
                        ...
                        <DivComponent clas={'footer relative shadow-lg md2:ml-[-2%] bg-gradient-to-r z-0 from-yellow-400 animate-pulse via-yellow-300 to-amber-500 transition duration-300 hover:scale-105 hover:animate-none  py-1 space-y-4 px-[1%] m-[5%] mt-[1%] mb-[10%]'}>
                            ...
                            <DivComponent clas='inner-footer-div  lg:flex ml-[10%] lg:!ml-[30%] sm2:!ml-[-30%] space-x-3' >
                                    <LabelSeparator2 labelText={'Admin Name:'} value={admin.username} />
                                    <LabelSeparator2 labelText={'Admin ID:'} value={admin.uniqueID} />
                                    <LabelSeparator2 labelText={'Email:'} value={admin.email} />                                    
                                    <LabelSeparator2 labelText={'Phone Number:'} value={phone} />                                    
                            </DivComponent>
                                ...
                                <DivComponent><label>Change Password:</label></DivComponent>
                                  ...
                                  <Button attrs={{ text: `${isChangingPassword ? 'Please wait...' : 'Done'} `, clas: 'px-2 !ml-[4%] generate-key-btn bg-blue-500 text-white rounded', onclick: changePassword }} />
                                </DivComponent>
                            </DivComponent>
                                ...
                                <DivComponent><label>Change Merchant code:</label></DivComponent>
                                   ...
                                   <Button attrs={{ text: `${isChangingCode ? 'Please wait...' : 'Done'} `, clas: 'px-2 !ml-[4%] generate-key-btn bg-blue-500 text-white rounded', onclick: changeMerchantCode }} />
                                </DivComponent>
                            </DivComponent>
                                ...
                                <DivComponent><label>Change Phone Number:</label></DivComponent>
                                  ...
                                  <Button attrs={{ text: `${isChangingNumber ? 'Please wait...' : 'Done'} `, clas: 'px-2 !ml-[4%] generate-key-btn bg-blue-500 text-white rounded', onclick: changePhoneNumber }} />
                                </DivComponent>
                            </DivComponent>
